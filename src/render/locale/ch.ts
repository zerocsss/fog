...
const ch = {
  view: {
    ...
    welcome: {
      ...
      welcome_page: {
        description_1: "是一个强大的Git客户端",
        description_2: "拥有所有的Git操作，可视化的审阅Git命令结果",
        description_3: "支持Git-Flow、Git-Hook、Git-LFS、Git-Credential、Git-Extension等功能",
        description_4: "支持GitHub、Gite、GitLab、Bitbucket、GitLab CE/EE等平台",
      },
      finish_page: {
        title: "恭喜你",
